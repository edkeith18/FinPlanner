...
///
/// A PlanYearLegacy is immutable once created and contains the calculated
/// state of the user's finances at the end of that year.
///
/// The sequence of PlanYears forms a PlanLegacy, where each year's ending
/// state becomes the starting point for the following year.
/// </summary>
public sealed class PlanYearLegacy
{
    /// <summary>
    /// The calendar year represented by this PlanYearLegacy.
    /// </summary>
