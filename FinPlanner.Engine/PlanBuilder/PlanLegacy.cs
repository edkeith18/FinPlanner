...
///
/// A PlanLegacy consists of an ordered collection of PlanYears beginning with
/// the first planning year and continuing through the final planning year.
/// Each PlanYearLegacy is calculated sequentially, with the ending state of one
/// year becoming the starting state of the next.
/// </summary>
public sealed class PlanLegacy
{
    /// <summary>
    /// Creates a new PlanLegacy.
    /// </summary>
    ...
    /// </param>
    public PlanLegacy(
        IReadOnlyList<PlanYearLegacy> planYears,
    ...
    /// The ordered collection of calculated plan planYears.
    /// </summary>
    public IReadOnlyList<PlanYearLegacy> PlanYears { get; }
    ...
    /// </summary>
    public PlanYearLegacy? LastYear =>
        PlanYears.LastOrDefault();

    /// <summary>
    /// Returns the PlanYearLegacy for the specified calendar year,
    /// or null if the year is not present in the plan.
    /// </summary>
    /// <param name="calendarYear">
    /// The calendar year to retrieve.
    /// </param>
    public PlanYearLegacy? GetYear(int calendarYear)
    {
